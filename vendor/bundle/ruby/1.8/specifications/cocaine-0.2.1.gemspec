...
Gem::Specification.new do |s|
  ...
  s.files = [".gitignore", ".travis.yml", "Gemfile", "LICENSE", "README.md", "Rakefile", "cocaine.gemspec", "lib/cocaine.rb", "lib/cocaine/command_line.rb", "lib/cocaine/exceptions.rb", "lib/cocaine/version.rb", "spec/cocaine/command_line_spec.rb", "spec/spec_helper.rb", "spec/support/stub_os.rb", "spec/support/with_exitstatus.rb"]
